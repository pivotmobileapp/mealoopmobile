...
document.addEventListener("pageinit", function (e) {
    ...
    switch (e.target.id) {
        ...
        case "page-home":
            ...
            if (typeof search_address === "undefined" || search_address == null || search_address == "") {} else {
            ...
            for (i = 0; i < dziuk.length; i++) {
                ...
                if (val.merchant_id == dziuk[i]) {
                    ...
                    if (getStorage("br_rest")) {
                        ...
                        htm += '<div><p style="font-size:18px;     font-weight: 600; float:left; color:black; width:62%; padding-bottom: 21px;">' + _name[i] + '</p><price style="float:left;    padding-top: 10px; font-size:26px">' + 'EC ' + _price[i] + '</price></div>';
                        htm += '<p class="restauran-title concat-text">' + val.restaurant_name + '</p>';
                        htm += '<p class="concat-textx">' + val.cuisine + '</p>';
...
function cancelOrder() {
    if (isLogin()) {
        menu.setMainPage('RequestCancelOrder.html', {
            closeMenu: true
        });
    } else {
        menu.setMainPage('RequestCancelOrder.html', {
...
function showAddressBook() {
    if (isLogin()) {
        menu.setMainPage('addressBook.html', {
            closeMenu: true
        });
    } else {
        menu.setMainPage('prelogin.html', {
