...
.controller('HomeCtrl', function($scope, $rootScope, $state, $ionicLoading,$http, PostService) {
	
	console.log(PostService);
		$http.get('http://mealoop.com/main/wp-json/wp/v2/posts').then(function (response) {
				$scope.employes = response.data;
	angular.forEach($scope.employes, function (value, key) {	
console.log(value)

console.log(value.content.rendered);
